...
<head>
    ...
    <title>Son Nguyen - Full Stack Developer</title>
...
<section id="home" class="text-center bg-image no-overflow" style="background-image: url(media/images/backgrounds/img44.jpg);" data-stellar-background-ratio="0.5">
        ...
        <div id="parallax-home" class="fullscreen inline-block">
            ...
            <div class="table" style="height: 100%">
                ...
                <div class="table-cell v-middle wow fadeIn">
                    ...
                    <!-- #HOME NAME -->
                    <h1 class="huge text-uppercase title-box">i'm son nguyen</h1>

                    <!-- #HOME PROFESSION NAME -->
                    <div class="table xs-padder profession-box">
                        <div class="table-cell">
                            <h5 class="text-capitalize semi-bold lh">A Full Stack Developer.</h5>
                        </div>
                    </div>
            ...
            <div class="main-title__inner">
                ...
                <div class="main-title__right">
                    <p class="serif em regular h6">
                        I'm Son, a full stack developer with 2 years of experience in PHP technologies , with good knowledge of Database Design, Object-Oriented and Design.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row main-block__padder text-left">
            ...
            <div class="col-lg-4 col-md-6 col-lg-push-4 text-center wow fadeInUp">
                <div class="inline-block photo-column-inner">
                    <div class="xlg-rounded-box profile-image-holder center-block">
                        <img src="media/images/photo-3.png" class="img-responsive" alt="#">
                    </div>
                    <div class="md-padder">
            ...
            <div class="col-lg-4 col-md-6 col-lg-push-4 info-column wow fadeInUp">
                <div>
                    ...
                    <ul class="padder list-unstyled info-list">
                        <li>Name : NGUYEN THAI MINH SON</li>
                        <li>Year of Birth: 1992</li>
                        <li>Phone : +84-922-298-536</li>
                        <li>Email : <a href="mailto:sonminh18@gmail.com">sonminh18@gmail.com</a></li>
                        <li>Adress : District 2, Ho Chi Minh City.</li>
                    </ul>
                    <ul class="list-inline list-gutter-xs padder h5 bare-social-menu">
                        <li>
                            <a href="https://stackoverflow.com/users/8756858/sonminh?tab=profile" class="twitter-color">
                                <i class="fa fa-stack-overflow"></i>
                            </a>
                        </li>
                        <li>
                            <a href="https://github.com/sonminh18" class="github-color">
            ...
            <div class="col-lg-4 col-lg-pull-8 col-xs-12 text-left story-column wow fadeInUp">
                <div>
                    ...
                    <p class="padder">
                        Development and new technologies is what I am passionate . I am considered a team-player because I like to help other and tend to work well within groups.
                    </p>
                    <p class="padder">
                        Unity is strength. One big project can't do by one man in one month. But one group can do it. So I like to work with other people, solve problem like a team.
                    </p>
                    <div class="lg-padder">
                        <img src="media/images/signature2.png" alt="#">
                    </div>
                </div>
            </div>
...
<section id="hobbies" class="secondary-block secondary-block-spacer bg-image" style="background-image: url(media/images/backgrounds/img3.jpg)" data-stellar-background-ratio="0.5">
            ...
            <ul class="list-inline inline-block text-uppercase list-gutter-md text-center text-uppercase hobbies-list">
                <li class="lg-rounded-box wow fadeInUp">
                    ...
                    <div class="inline-block">
                        ...
                        <h6 class="padder normal lh">Gaming</h6>
                    </div>

                    <!-- HOOBY DESCRIPTION -->
                    <div class="hobby-description">
                        <p>
                            Playing game help me to relieve pressure after a long day working hard. My favorite game is strategy. It make me improve thinking and teamwork.
                        </p>
                    </div>
                ...
                <li class="lg-rounded-box wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="hobby-description">
                        <p>
                            My dreaming is traveling far away from my home. Meeting other people, see other places. I think it's a greatest thing in my life.
                        </p>
                    </div>
                ...
                <li class="lg-rounded-box wow fadeInUp" data-wow-delay="0.6s">
                    ...
                    <div class="hobby-description">
                        <p>
                            In some way, Music can make people happy, express and modulate emotions. So music also is alternate the way I relieve pressure.
                        </p>
                    </div>
                ...
                <li class="lg-rounded-box wow fadeInUp" data-wow-delay="0.9s">
                    ...
                    <div class="hobby-description">
                        <p>
                            I love movie, I love the cinema.
                        </p>
                    </div>
                ...
                <li class="lg-rounded-box wow fadeInUp" data-wow-delay="1.2s">
                    ...
                    <div class="inline-block">
                        ...
                        <h6 class="padder normal lh">Sport</h6>
                    </div>

                    <!-- HOOBY DESCRIPTION -->
                    <div class="hobby-description">
                        <p>
                            Sport also the other way to help me felling happy, join a battle, play with teammate , defeat the enemy with unity strength and improve healthy. That is my purpose to play sports.
                        </p>
                    </div>
    ...
    <div class="container text-center">
        ...
        <div class="main-title text-left wow fadeIn">
            <div class="main-title__inner">
                ...
                <div class="main-title__right">
                    <p class="serif em regular h6">
                        Although programing isn't my primary major when I was student, but I have special emotion for it. After I had graduated university, I decided to become Web Developer. I think it is the greatest choosen for me, because "Career choose you , not your chosen career".
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="timeline-items list-gutter-lg">
                        ...
                        <div class="clearfix timeline-item">
                            ...
                            <div class="pull-left clearfix text-center">
                                ...
                                <div class="inline-block v-middle">
                                    ...
                                    <span class="h3 light">2.53</span>
                                    <small class="bold">GPA</small>
                                </div>
                            ...
                            <div class="no-overflow timeline-item-info wow fadeInRight">
                                <h6 class="text-capitalize lh">Bachelor Degree of Computer Networking</h6>
                                <ul class="list-inline list-gutter-xs em serif text-capitalize sm-padder timeline-info-list">
                                    <li>Hoa Sen University</li>
                                    {{--<li>&#8226;</li>--}}
                                    {{--<li>Bachelor Degree</li>--}}
                                </ul>
                                <p class="padder">
                                    Have strongly knowledge about networking, routing algorithms ,operations and management.
                                    <p>GPA: 2.53/4.</p>
                                    <p>Degree grade: Good</p>
                        ...
                        <div class="clearfix timeline-item hidden">
                            ...
                            <div class="no-overflow timeline-item-info">
                                ...
                                <ul class="list-inline list-gutter-xs em serif text-capitalize sm-padder timeline-info-list">
                                    <li>Giong Ong To High School</li>
                                    {{--<li>&#8226;</li>--}}
                                    {{--<li>USA</li>--}}
                                </ul>
                                <p class="padder">
                ...
                <div class="timeline">
                    ...
                    <div class="timeline-items list-gutter-lg">
                        ...
                        <div class="clearfix timeline-item">
                            ...
                            <!-- TIMELINE ITEM CONTENT -->
                            <div class="no-overflow timeline-item-info wow fadeInRight">
                                <h6 class="text-capitalize lh">web developer</h6>
                                <ul class="list-inline list-gutter-xs em serif text-capitalize sm-padder timeline-info-list">
                                    <li>Online Data Services</li>
                                    <li>&#8226;</li>
                                    <li>Tan Binh, HCM City</li>
                                </ul>
                                <p class="padder">
                            ...
                            <div class="pull-left clearfix text-center">
                                ...
                                <div class="inline-block v-middle">
                                    ...
                                    <div class="custom-tooltip bold text-uppercase small inline-block v-middle hidden-xs wow fadeInLeft">
										...
										--><div class="timeline-box inline-block v-middle hidden-xs text-uppercase wow fadeInRight" ></div>

                            </div>

                            <!-- TIMELINE ITEM CONTENT -->
                            <div class="no-overflow timeline-item-info wow fadeInRight">
                                <h6 class="text-capitalize lh">technical support</h6>
                                <ul class="list-inline list-gutter-xs em serif text-capitalize sm-padder timeline-info-list">
                                    <li>Online Data Services</li>
                                    <li>&#8226;</li>
                                    <li>Tan Binh, HCM City</li>
                        ...
                        <div class="clearfix timeline-item hidden">
                            ...
                            <!-- TIMELINE ITEM CONTENT -->
                            <div class="no-overflow timeline-item-info">
                                <h6 class="text-capitalize lh">part time</h6>
                                <ul class="list-inline list-gutter-xs em serif text-capitalize sm-padder timeline-info-list">
                                    <li>coffe shop</li>
                                    {{--<li>&#8226;</li>--}}
                                    {{--<li>USA</li>--}}
...
<section id="milestones" class="secondary-block-spacer">
    ...
    <ul class="list-unstyled text-center text-uppercase milestones-list">
        <li>
            ...
            <h1 class="heavy lh md-padder" data-from="0" data-to="364">364</h1>
            <span class="lh inline-block semi-bold padder">friend on facebook</span>
        </li><!--
				--><li>
            <div class="mega">
                <i class="fa fa-fw fa-briefcase"></i>
            </div>
            <h1 class="heavy lh md-padder" data-from="0" data-to="400">400</h1>
            <span class="lh inline-block semi-bold padder">coffe cups</span>
        </li><!--
				--><li>
            <div class="mega">
                <i class="fa fa-fw fa-clock-o"></i>
            </div>
            <h1 class="heavy lh md-padder" data-from="0" data-to="2">2</h1>
            ...
            <h1 class="heavy lh md-padder in-millions" data-from="0" data-to="1">1</h1>
    ...
    <div class="container text-center">
        ...
        <div class="main-title text-left wow fadeIn">
            <div class="main-title__inner">
                ...
                <div class="main-title__right">
                    <p class="serif em regular h6">
                        "If you want people to know how much you care, show them how much you remember. Learn their names and use them often. It's an important skill to develop." <br>- Harvey Mackay -
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="row tab-pane skills-list text-capitalize" id="skill-panel-4">
                    ...
                    <div class="col-md-4 col-sm-6 text-center">
                        <ul class="colored-bullets checked-list list-gutter-sm list-unstyled inline-block text-left">
                            <li>DB design</li>
                            <li>RESTful APIs</li>
                            <li>Knowledge at OOP</li>
                            <li>PHP framework Laravel</li>
                        </ul>
                    </div>
                    <div class="col-md-4 col-sm-6 text-center">
                        <ul class="colored-bullets checked-list list-gutter-sm list-unstyled inline-block text-left">
                            <li>Knowledgeable VoIP</li>
                            <li>Grid &amp; Layout</li>
                            <li>Web Usability</li>
                            <li>Responsive</li>
                        </ul>
...
{{--<section id="process" class="secondary-block secondary-block-spacer bg-image" style="background-image: url(media/images/backgrounds/home_callcenter_section_bg.jpg)" data-stellar-background-ratio="0">--}}
        ...
        {{--<div class="secondary-block__padder">--}}
            {{--<div class="row text-center clients-list">--}}
                {{--<div class="col-lg-2 col-md-4 col-sm-6 wow fadeInUp">--}}
                    {{--<a href="#" style="background-image: url(media/images/clients/dien-may-bay-thien.png)"></a>--}}
                {{--</div>--}}
                {{--<div class="col-lg-2 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">--}}
                    {{--<a href="#" style="background-image: url(media/images/clients/kimnga-logo.png)"></a>--}}
                {{--</div>--}}
                {{--<div class="col-lg-2 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.6s">--}}
                    {{--<a href="#" style="background-image: url(media/images/clients/logo2.png)"></a>--}}
                {{--</div>--}}
                {{--<div class="col-lg-2 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.9s">--}}
                    {{--<a href="#" style="background-image: url(media/images/clients/logo6.png)"></a>--}}
                {{--</div>--}}
...
<section id="testimonials" class="secondary-block bg-image" style="background-image: url(media/images/backgrounds/001.jpg)" data-stellar-background-ratio="0.5">
        ...
        <div class="col-md-8 col-md-push-2 secondary-block__sub-padder">
            ...
            <div class="quotes">
                ...
                <div class="quote">
                    ...
                    <div class="lg-padder inline-block text-left list-gutter-sm">
                        <div class="md-rounded-box inline-block v-middle">
                            <img src="media/images/testimonials/1c1bf73.jpg" alt="#" class="img-responsive">
                        </div>
                        <div class="inline-block v-middle">
                            <h6 class="semi-bold">Michael Sinz</h6>
                ...
                <div class="quote">
                    ...
                    <div class="lg-padder inline-block text-left list-gutter-sm">
                        <div class="md-rounded-box inline-block v-middle">
                            <img src="media/images/testimonials/images.jpg" alt="#" class="img-responsive">
                        </div>
                        <div class="inline-block v-middle">
                            <h6 class="semi-bold">Edsger Dijkstra</h6>
                ...
                <div class="quote">
                    ...
                    <div class="lg-padder inline-block text-left list-gutter-sm">
                        <div class="md-rounded-box inline-block v-middle">
                            <img src="media/images/testimonials/xVAFH9ZH_400x400.jpg" alt="#" class="img-responsive">
                        </div>
                        <div class="inline-block v-middle">
                            <h6 class="semi-bold">Bill Gates </h6>
                            <span class="light inline-block xs-padder testimonial-job">(co-founder of Microsoft)</span>
                        </div>
                    </div>
                </div>
    ...
    <div class="container text-center">
        ...
        <div class="main-block__padder text-left wow fadeIn">
            ...
            <div class="main-block__sub-padder tab-content text-left">
                ...
                <!-- HIRE FORM -->
                <div id="contact-panel-1" class="tab-pane">
                ...
                <!-- CONTACT FORM -->
                <div id="contact-panel-2" class="tab-pane active">
